...
# ── Ad eşleme — veri katmanı modülünde (takim_adi.py) ─────────────────
# İlk sürüm burada tanımlıydı; lig kodu tespiti de (fetch_iddaa_live)
# aynı eşlemeyi kullanınca veri katmanı bir ajan takımına bağımlı olmasın
# diye takim_adi.py'ye taşındı (19.09.2026). Adlar burada da erişilir.
from takim_adi import (_DUR, ELLE, _temiz, _jeton, _onek, _uyum,  # noqa: E402,F401
                       _yedek_mi, esle_ad)
